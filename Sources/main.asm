...
do_exercise:
		    ...
		    CLRA ; READING PORT 
	 		...
	 		BSET 2,PTDD							; This part is for data reception
...
aloha:				PULA ; Throw CCR away
					PULA ; Throw A away
					PULA ; Throw X away
					PULA ; Throw PCH away 
					PULA ; Throw PCL away  
					LDHX #_Startup ; New address after interrupt
					PSHX  
					PSHH
					CLRA
					PSHA
...
end_IRQ:		  	 JSR show_time     ;| Display time 
